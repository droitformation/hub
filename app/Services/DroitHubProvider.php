...
class DroitHubProvider extends AbstractProvider implements ProviderInterface
{
    ...
    {
        return $this->buildAuthUrlFromBase('http://shop.local/oauth/authorize', $state);
    }
    ...
    {
        return 'http://shop.local/oauth/access_token';
    }
    ...
    {
        $userUrl  = 'http://shop.local/api/user?access_token='.$token;
